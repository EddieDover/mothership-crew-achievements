...
async function compileSass() {
  const scssFile = path.join(SRC_DIR, "styles", "crew-achievements.scss");
  const cssOutputFile = path.join(DIST_DIR, "styles", "crew-achievements.css");
...
async function createZip() {
  const packageName = "mothership-crew-achievements.zip";
